//! no_std, no alloc, zero copy, space efficient implementation of xPI requests and replies based
...
//! lower bandwidth channels (for example CAN Bus). With the tricks employed, it is for example
